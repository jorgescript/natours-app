...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoiam9yZ2VzY3JpcHQiLCJhIjoiY2tlbG0xdzE0MGlqejJ5bXN2dHNycTdzMCJ9.r9f8EvZrmU_7xSHVNxJ4YA";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Now you are logged in");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateSetings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "data" ? "http://127.0.0.1:3000/api/v1/users/update-my-data" : "http://127.0.0.1:3000/api/v1/users/update-my-password";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourID) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_JqjOzSlglZsiXmPvpzZJOrpo00SxWQWeWZ");
            _context.prev = 1;
            _context.next = 4;
...
if (formData) {
  formData.addEventListener("submit", function (e) {
    ...
    (0, _updateSetings.updateSetings)(form, "data");
  });
}
/* UPDATDE PASSWORD */
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _updateSetings.updateSetings)({
